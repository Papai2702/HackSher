      ...
      <div className="relative z-10">
        ...
        >
          <div className="flex items-center">
            <span className="text-3xl font-black text-white tracking-wider">About.US</span>
          </div>

          <div className="flex items-center space-x-6">
            <motion.button
              whileHover={{ scale: 1.05, backgroundColor: "#22c55e", boxShadow: "0 8px 16px rgba(34, 197, 94, 0.4)" }}
              whileTap={{ scale: 0.95 }}
              className="bg-green-500 text-white font-bold py-3 px-8 rounded-full shadow-lg transition-all duration-300 text-base tracking-wide"
            >
              VISIT OUR DOCS
            </motion.button>
            ...
            <div className="flex items-center space-x-6">
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer">
                <X size={24} className="text-gray-300 hover:text-white cursor-pointer transition-colors duration-300" />
              </a>
              <a href="https://github.com" target="_blank" rel="noopener noreferrer">
                <Github size={24} className="text-gray-300 hover:text-white cursor-pointer transition-colors duration-300" />
              </a>
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer">
                <Linkedin size={24} className="text-gray-300 hover:text-white cursor-pointer transition-colors duration-300" />
              </a>
              <Settings size={24} className="text-gray-300 hover:text-white cursor-pointer transition-colors duration-300" />
              <User size={24} className="text-gray-300 hover:text-white cursor-pointer transition-colors duration-300" />
            </div>
          </div>
        </motion.nav>
        ...
        <main className="container mx-auto px-8 py-20 space-y-32">
          ...
          >
            <div className="flex flex-col space-y-8">
              ...
              >
                Data-Backed <span className="text-green-400">Strategy</span>
              </motion.h1>
              ...
              >
                We transform complex data into actionable insights that drive your business forward. Our analytics provide the clarity you need to make informed decisions.
              </motion.p>
              ...
              >
                ...
                <motion.button
                  whileHover={{ scale: 1.05, backgroundColor: "rgba(255, 255, 255, 0.05)", boxShadow: "0 8px 16px rgba(255, 255, 255, 0.1)" }}
                  whileTap={{ scale: 0.95 }}
            ...
            <motion.div
              ...
              className="relative w-full h-[32rem] bg-cover bg-center rounded-3xl flex flex-col items-center justify-center overflow-hidden shadow-2xl border border-white/10"
              style={{ backgroundImage: `url('https://i.pinimg.com/736x/57/f9/07/57f9075487a4cef6fbfc114c67d78bc7.jpg')` }} // Updated background image
          ...
          >
            ...
            <a href="/" onClick={navigateToHome} className="block w-full h-full">
              <motion.div
                whileHover={{ scale: 1.01, boxShadow: "0 20px 40px rgba(0, 0, 0, 0.5)" }}
            ...
            <div className="flex flex-col space-y-8">
              ...
              >
                <div className="flex items-center justify-between">
                  <h3 className="text-3xl font-bold text-white tracking-tight">Performance Analytics</h3>
                ...
                <p className="text-lg text-gray-300 leading-relaxed tracking-wide">
                  We analyze every move with data to back decisions that matter. Deep insights, real results — track, tweak, triumph.
                </p>
                <motion.button
                  whileHover={{ scale: 1.03, backgroundColor: "rgba(34, 197, 94, 0.1)", boxShadow: "0 4px 8px rgba(34, 197, 94, 0.2)" }}
                  whileTap={{ scale: 0.97 }}
              ...
              >
                <div className="flex items-center justify-between">
                  <h3 className="text-3xl font-bold text-white tracking-tight">Emotional Intelligence</h3>
                  {/* Icons are removed from here as they were not in the reference image for these cards */}
                </div>
                <p className="text-lg text-gray-300 leading-relaxed tracking-wide">
                  Designs and narratives that capture the attention of your audience. From memes to momentum — we grow your digital presence.
                </p>
                <motion.button
                  whileHover={{ scale: 1.03, backgroundColor: "rgba(168, 85, 247, 0.1)", boxShadow: "0 4px 8px rgba(168, 85, 247, 0.2)" }}
                  whileTap={{ scale: 0.97 }}
        ...
        <footer className="border-t border-white/10 py-8">
          <div className="container mx-auto px-8 flex justify-between items-center">
            <span className="text-gray-400">© 2025 404-BNF. All rights reserved.</span>
